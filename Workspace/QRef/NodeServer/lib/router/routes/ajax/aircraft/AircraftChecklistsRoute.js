(function() {
  var AircraftChecklistFilter, AircraftChecklistsRoute, AjaxResponse, AjaxRoute, ChecklistManager, QRefDatabase, UserAuth,
  ...
  AircraftChecklistsRoute = (function(_super) {
    ...
    AircraftChecklistsRoute.prototype.get = function(req, res) {
      ...
      return UserAuth.validateToken(token, function(err, isTokenValid) {
        ...
        return filter.constrainQuery({}, function(err, objQuery) {
    ...
    AircraftChecklistsRoute.prototype.post = function(req, res) {
      ...
      return UserAuth.validateToken(token, function(err, isTokenValid) {
        ...
        return filter.create(function(err, isAllowed) {
